            ...
            <div class="grid-tweet">
               ...
               <?php } } ?>
                ...
                <div class="row home-follow pt-3">
                     ...
                     <span class="home-follow-count"> <?php echo $retweets_count ; ?> </span> Regurgitations</i>
                        </div> 
                        <?php } ?> 
                        ...
                        <div class="col-md-2 users-count">
                            ...
                            if($retweet_sign)
                             ...
                             <span class="home-follow-count">  <?php echo $likes_count ; ?>  </span> Licks</i>
                        </div>   
                        <?php } ?> 
                  </div>
                ...
                <div class="grid-reactions">
                  ...
                  <div class="grid-box-reaction">
                    ...
                    <!--<a href="./handle/handleDeleteTweet.php?postid=<?php //echo $postid;?>"><i class="fas fa-trash" color="red" ></form></i></a>-->
                    </div>
