...
<div class='chatcontrols'>
	...
	<input type='text' name='chat' id='chatbox' autocomplete="off" placeholder="Type message here- all times are in UTC" />
