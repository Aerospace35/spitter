<?php
   ...
   $tweets = Tweet::alltweets($user_id);
   $who_users = Follow::whoToFollowAll($user_id);
                      ...
                      <form class="" action="handle/handleTweet.php" method="post" enctype="multipart/form-data">
                        <div class="inner">
                          ...
                          <label>
                            ...
                            <textarea class="text-whathappen" name="status" rows="8" cols="80" placeholder="Discover lists every Spit, period."></textarea>
